...
- **Bug 报告**——开一个带复现步骤的
  [GitHub issue](https://github.com/parag2884/open-code-review/issues/new/choose)。
- **功能请求**——在
...
4. **更新文档。** 若变更影响参数、config key 或评审流水线，同时更新本文档站
  （在 [`docs/`](https://github.com/parag2884/open-code-review)）与任何相关内联帮助。
...
贡献按 Apache-2.0 许可。详见 [LICENSE](https://github.com/parag2884/open-code-review/blob/main/LICENSE)
与 [NOTICE](https://github.com/parag2884/open-code-review/blob/main/NOTICE)。

## 首次贡献？

找标了
[`good first issue`](https://github.com/parag2884/open-code-review/labels/good%20first%20issue)
或 [`help wanted`](https://github.com/parag2884/open-code-review/labels/help%20wanted)
