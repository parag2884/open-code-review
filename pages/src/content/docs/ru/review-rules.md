...
[`internal/agent/selection.go`](https://github.com/parag2884/open-code-review/blob/main/internal/agent/selection.go).
Для каждого diff OCR спрашивает:

1. **`binary`** — Файл бинарный? Исключается.
2. **`secret_exclude`** — Старый или новый путь подпадает под встроенную защиту секретных путей? Безусловные glob-шаблоны перечислены в [`default_secret_patterns.json`](https://github.com/parag2884/open-code-review/blob/main/internal/config/allowlist/default_secret_patterns.json). Если да, путь исключается.
...
5. **`unsupported_ext`** — Расширение файла есть в
   [списке разрешённых](https://github.com/parag2884/open-code-review/blob/main/internal/config/allowlist/supported_file_types.json)?
...
[`internal/config/allowlist/default_exclude_patterns.json`](https://github.com/parag2884/open-code-review/blob/main/internal/config/allowlist/default_exclude_patterns.json))
...
[`internal/diff/git.go`](https://github.com/parag2884/open-code-review/blob/main/internal/diff/git.go),
