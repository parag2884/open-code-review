...
- **建议功能** — 有改进想法？可以在 [GitHub Discussions](https://github.com/parag2884/open-code-review/discussions/categories/ideas) 中发起讨论，或直接提交一个 [Feature Request](https://github.com/parag2884/open-code-review/issues/new?template=feature_request.yml) issue。
- **改进文档** — 修复错别字、完善说明或补充示例。也可以提交一个 [Documentation Issue](https://github.com/parag2884/open-code-review/issues/new?template=docs_report.yml) 来报告文档问题。
...
1. 如果你发现问题但暂时不打算自己修复，请提交一个 [Documentation Issue](https://github.com/parag2884/open-code-review/issues/new?template=docs_report.yml)。
...
贡献按 Apache-2.0 许可。详见 [LICENSE](../../LICENSE) 与 [NOTICE](../../NOTICE)。

## 新手推荐

第一次参与？可以关注以下标签的 issue：

- [`good first issue`](https://github.com/parag2884/open-code-review/labels/good%20first%20issue) — 小型、范围明确的任务，适合快速上手。
- [`help wanted`](https://github.com/parag2884/open-code-review/labels/help%20wanted) — 我们希望得到社区帮助的问题。
...
- **Bug 报告** — [GitHub Issues](https://github.com/parag2884/open-code-review/issues)
- **功能建议** — [GitHub Discussions (Ideas)](https://github.com/parag2884/open-code-review/discussions/categories/ideas) 或 [Feature Request Issue](https://github.com/parag2884/open-code-review/issues/new?template=feature_request.yml)
- **使用疑问与帮助** — 对 OpenCodeReview 的使用有任何疑问，欢迎在 [GitHub Discussions](https://github.com/parag2884/open-code-review/discussions) 中提问交流
