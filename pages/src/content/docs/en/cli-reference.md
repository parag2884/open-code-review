...
quiet-able stdout writer ([`internal/stdout`](https://github.com/parag2884/open-code-review/blob/main/internal/stdout/stdout.go)).
...
[`internal/config/testconnection/task.json`](https://github.com/parag2884/open-code-review/blob/main/internal/config/testconnection/task.json),
and prints:
...
and the GitHub URL (`https://github.com/parag2884/open-code-review`).
