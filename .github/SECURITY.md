...
Instead, use **GitHub Private Vulnerability Reporting** — go to the [Security Advisories](https://github.com/parag2884/open-code-review/security/advisories/new) page and submit a new advisory.
...
```bash
gh attestation verify opencodereview-linux-amd64 --repo parag2884/open-code-review
```
