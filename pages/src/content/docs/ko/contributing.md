...
[`CONTRIBUTING.md`](https://github.com/parag2884/open-code-review/blob/main/CONTRIBUTING.md)에
있습니다.
...
- **버그 신고** — 재현 절차를 담아
  [GitHub 이슈](https://github.com/parag2884/open-code-review/issues/new/choose)를
  열어 주세요.
- **기능 제안** —
  [Discussions](https://github.com/parag2884/open-code-review/discussions/categories/ideas)에
...
1. [`internal/config/toolsconfig/tools.json`](https://github.com/parag2884/open-code-review/blob/main/internal/config/toolsconfig/tools.json)의
...
4. **문서를 갱신하세요.** 플래그나 설정 키, 리뷰 파이프라인에 영향이 있는
   변경이라면 이 문서 사이트([`docs/`](https://github.com/parag2884/open-code-review))와
...
기여는 Apache-2.0으로 수락됩니다.
[LICENSE](https://github.com/parag2884/open-code-review/blob/main/LICENSE)와
[NOTICE](https://github.com/parag2884/open-code-review/blob/main/NOTICE)를 참고하세요.

## 처음 기여하시나요? {#first-contribution}

[`good first issue`](https://github.com/parag2884/open-code-review/labels/good%20first%20issue)나
[`help wanted`](https://github.com/parag2884/open-code-review/labels/help%20wanted)
