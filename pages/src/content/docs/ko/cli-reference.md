...
([`internal/stdout`](https://github.com/parag2884/open-code-review/blob/main/internal/stdout/stdout.go)).
...
[`internal/config/testconnection/task.json`](https://github.com/parag2884/open-code-review/blob/main/internal/config/testconnection/task.json)에
...
날짜(있을 때), GitHub URL(`https://github.com/parag2884/open-code-review`)을 출력합니다.
