...
- **Suggest features** — Have an idea for improvement? You can start a conversation in [GitHub Discussions](https://github.com/parag2884/open-code-review/discussions/categories/ideas) or open a [Feature Request](https://github.com/parag2884/open-code-review/issues/new?template=feature_request.yml) issue.
- **Improve documentation** — Fix typos, clarify explanations, or add examples. You can also open a [Documentation Issue](https://github.com/parag2884/open-code-review/issues/new?template=docs_report.yml) to report problems.
...
git remote add upstream https://github.com/parag2884/open-code-review.git
...
> **Note:** The `upstream` remote is read-only for contributors. Push to your fork (`origin`) and open a Pull Request.
...
1. If you spot an issue but don't plan to fix it yourself, open a [Documentation Issue](https://github.com/parag2884/open-code-review/issues/new?template=docs_report.yml).
...
4. **License** — Contributions are accepted under the Apache-2.0 license.
...
Contributions are licensed under Apache-2.0. See [LICENSE](LICENSE) and [NOTICE](NOTICE).

## First-Time Contributors

New to the project? Look for issues labeled:

- [`good first issue`](https://github.com/parag2884/open-code-review/labels/good%20first%20issue) — Small, well-scoped tasks ideal for getting started.
- [`help wanted`](https://github.com/parag2884/open-code-review/labels/help%20wanted) — Issues where we'd appreciate community help.
...
- **Bug Reports** — [GitHub Issues](https://github.com/parag2884/open-code-review/issues)
- **Feature Suggestions** — [GitHub Discussions (Ideas)](https://github.com/parag2884/open-code-review/discussions/categories/ideas) or [Feature Request Issue](https://github.com/parag2884/open-code-review/issues/new?template=feature_request.yml)
- **Questions & Help** — If you have any questions about using OpenCodeReview, feel free to ask in [GitHub Discussions](https://github.com/parag2884/open-code-review/discussions)
