...
[`internal/llmloop/`](https://github.com/parag2884/open-code-review/blob/main/internal/llmloop/).
...
[`whyExcluded`](https://github.com/parag2884/open-code-review/blob/main/internal/agent/selection.go).
...
[`grouping.go`](https://github.com/parag2884/open-code-review/blob/main/internal/agent/grouping.go))
...
[`agent.go`](https://github.com/parag2884/open-code-review/blob/main/internal/agent/agent.go).
The template itself isn't a CLI override — to change prompts you edit
[`task_template.json`](https://github.com/parag2884/open-code-review/blob/main/internal/config/template/task_template.json)
