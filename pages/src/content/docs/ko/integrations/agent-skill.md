...
저장소에는 SKILL 매니페스트가
[`skills/open-code-review/SKILL.md`](https://github.com/parag2884/open-code-review/blob/main/skills/open-code-review/SKILL.md)에
...
이 명령은
[스킬 레지스트리](https://github.com/parag2884/open-code-review/blob/main/skills/open-code-review/SKILL.md)에서
