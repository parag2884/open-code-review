...
与完整输出的 [GitHub issue](https://github.com/parag2884/open-code-review/issues)。
...
“脱敏规则”功能在路线图上；关注
[issue 跟踪器](https://github.com/parag2884/open-code-review/issues)。
...
issue 已在[此](https://github.com/parag2884/open-code-review/issues)开放。
