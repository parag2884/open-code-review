...
через `uses: parag2884/open-code-review@main`. Помимо учётных данных выше,
...
По умолчанию параллельно работают 8 субагентов — по одному на подзадачу.
...
(по умолчанию 8, по одному на подзадачу):
