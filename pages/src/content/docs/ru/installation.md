...
`https://<зеркало>/github.com/parag2884/open-code-review/releases/download/<версия>/…`.
...
[страницы релизов](https://github.com/parag2884/open-code-review/releases):
