...
- **Bug reports** — open a [GitHub issue](https://github.com/parag2884/open-code-review/issues/new/choose)
...
1. **JSON definition** in
   [`internal/config/toolsconfig/tools.json`](https://github.com/parag2884/open-code-review/blob/main/internal/config/toolsconfig/tools.json):
...
4. **Update docs.** If the change affects flags, config keys, or the
   review pipeline, update both this docs site (in [`docs/`](https://github.com/parag2884/open-code-review))
...
or [`help wanted`](https://github.com/parag2884/open-code-review/labels/help%20wanted).
