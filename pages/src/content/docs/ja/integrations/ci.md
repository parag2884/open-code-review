...
上流のワークフローは
[`examples/github_actions/ocr-review.yml`](https://github.com/parag2884/open-code-review/blob/main/examples/github_actions/ocr-review.yml)
にあります。
...
curl -o .github/workflows/ocr-review.yml \
  https://raw.githubusercontent.com/parag2884/open-code-review/main/examples/github_actions/ocr-review.yml
```
...
上流のワークフローは、`uses: parag2884/open-code-review@main` を通じてレビューを再利用可能なコンポジットアクション（[`action.yml`](https://github.com/parag2884/open-code-review/blob/main/action.yml)）に委譲しています。上記の認証情報に加えて、以下の入力でレビュー自体を調整できます——アクションステップの `with:` に指定してください。
...
入力の完全な一覧は
[`action.yml`](https://github.com/parag2884/open-code-review/blob/main/action.yml)
...
上流のパイプラインは
[`examples/gitlab_ci/.gitlab-ci.yml`](https://github.com/parag2884/open-code-review/blob/main/examples/gitlab_ci/.gitlab-ci.yml)
にあります。
...
curl -o .gitlab-ci.yml \
  https://raw.githubusercontent.com/parag2884/open-code-review/main/examples/gitlab_ci/.gitlab-ci.yml
```
