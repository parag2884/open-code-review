...
リポジトリには
[`skills/open-code-review/SKILL.md`](https://github.com/parag2884/open-code-review/blob/main/skills/open-code-review/SKILL.md)
...
```bash
npx skills add parag2884/open-code-review --skill open-code-review
```

これは
[skills registry](https://github.com/parag2884/open-code-review/blob/main/skills/open-code-review/SKILL.md)
