...
전체 흐름을 지휘하는 코드는
[`internal/agent/`](https://github.com/parag2884/open-code-review/blob/main/internal/agent/)
...
[`internal/llmloop/`](https://github.com/parag2884/open-code-review/blob/main/internal/llmloop/)에
...
[`whyExcluded`](https://github.com/parag2884/open-code-review/blob/main/internal/agent/selection.go)를
...
[`grouping.go`](https://github.com/parag2884/open-code-review/blob/main/internal/agent/grouping.go)의
...
플레이스홀더 치환 코드는
[`agent.go`](https://github.com/parag2884/open-code-review/blob/main/internal/agent/agent.go)에
있습니다. 템플릿 자체는 CLI로 덮어쓸 수 없습니다. 프롬프트를 바꾸려면
[`task_template.json`](https://github.com/parag2884/open-code-review/blob/main/internal/config/template/task_template.json)을
