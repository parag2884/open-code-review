...
description: >
  ...
  parag2884/open-code-review. Use when the user asks to review code, review
...
metadata:
  author: parag2884
  homepage: https://github.com/parag2884/open-code-review
  version: "1.0.0"
---
...
A skill for invoking [open-code-review](https://github.com/parag2884/open-code-review) (`ocr`) — an open-source AI code review CLI that reads Git diffs and generates structured, line-level review comments.
...
- **Comment language follows config** — the `language` config controls review comment language, defaults to `English`, and accepts any language name (for example `English`).
...
- Full docs: https://github.com/parag2884/open-code-review
- NPM package: https://www.npmjs.com/package/@alibaba-group/open-code-review
- Issue tracker: https://github.com/parag2884/open-code-review/issues
