...
- **Сообщения об ошибках** — создайте [задачу на GitHub](https://github.com/parag2884/open-code-review/issues/new/choose)
...
4. **Обновляйте документацию.** Если изменение затрагивает флаги, ключи
   ...
   [`docs/`](https://github.com/parag2884/open-code-review)), и соответствующую
   встроенную справку.
...
Вклады принимаются на условиях Apache-2.0. См.
[LICENSE](https://github.com/parag2884/open-code-review/blob/main/LICENSE) и
[NOTICE](https://github.com/parag2884/open-code-review/blob/main/NOTICE).
...
или [`help wanted`](https://github.com/parag2884/open-code-review/labels/help%20wanted).
