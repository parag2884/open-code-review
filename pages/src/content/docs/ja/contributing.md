...
[`CONTRIBUTING.md`](https://github.com/parag2884/open-code-review/blob/main/CONTRIBUTING.md) にあります。
...
- **バグ報告**——再現手順を添えて
  [GitHub issue](https://github.com/parag2884/open-code-review/issues/new/choose) を作成してください。
- **機能リクエスト**——
  [Discussions](https://github.com/parag2884/open-code-review/discussions/categories/ideas)
...
1. [`internal/config/toolsconfig/tools.json`](https://github.com/parag2884/open-code-review/blob/main/internal/config/toolsconfig/tools.json)
...
4. **ドキュメントを更新してください。** 変更が引数、config key、レビューパイプラインに影響する場合は、
   本ドキュメントサイト（[`docs/`](https://github.com/parag2884/open-code-review) 内）と関連するインラインヘルプの
   両方を更新してください。
...
貢献は Apache-2.0 の下で受け付けます。[LICENSE](https://github.com/parag2884/open-code-review/blob/main/LICENSE)
と [NOTICE](https://github.com/parag2884/open-code-review/blob/main/NOTICE) を参照してください。

## 初めての貢献ですか？

[`good first issue`](https://github.com/parag2884/open-code-review/labels/good%20first%20issue)
または [`help wanted`](https://github.com/parag2884/open-code-review/labels/help%20wanted)
