...
업스트림 워크플로는
[`examples/github_actions/ocr-review.yml`](https://github.com/parag2884/open-code-review/blob/main/examples/github_actions/ocr-review.yml)에
있습니다.
...
업스트림 워크플로는 `uses: parag2884/open-code-review@main`으로 리뷰를 재사용 가능한
컴포짓 액션([`action.yml`](https://github.com/parag2884/open-code-review/blob/main/action.yml))에
...
전체 입력 목록은
[`action.yml`](https://github.com/parag2884/open-code-review/blob/main/action.yml)을
...
업스트림 파이프라인은
[`examples/gitlab_ci/.gitlab-ci.yml`](https://github.com/parag2884/open-code-review/blob/main/examples/gitlab_ci/.gitlab-ci.yml)에
있습니다.
