...
const RAW = "https://raw.githubusercontent.com/parag2884/open-code-review/main/";
const BLOB = "https://github.com/parag2884/open-code-review/blob/main/";
const TREE = "https://github.com/parag2884/open-code-review/tree/main/";
...
function testNonPathUrlsIgnored() {
  ...
  const md = [
    "https://github.com/parag2884/open-code-review/issues/1100",
    "https://github.com/parag2884/open-code-review/pull/424",
    "https://github.com/parag2884/open-code-review/releases/download/v1.0.0/x",
    "https://github.com/parag2884/open-code-review",
  ].join("\n");
  assert.deepStrictEqual(extractRepoLinks(md), []);
}
